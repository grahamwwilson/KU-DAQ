...
//               lout << " Type: 0x" << std::setfill('0') << std::setw(2) << hex << dtype << " Data: 0x" << std::setfill('0') << std::setw(8) << hex << r << endl;
    ...
    lout << "average read event size = " << std::setw(10) << double(bytes_read)/(4.0*double(nevs_read)) << " words " << endl;
    lout << " " << endl;
    lout << "events written out = " << dec << nevs_written << endl;
    lout << "words written out = " << dec << nwords_written << endl;
    lout << "average written event size = " << std::setw(10) << double(nwords_written)/double(nevs_written) << " words " << endl;
    lout << " " << endl;
